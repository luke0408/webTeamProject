var Page = { 
  ...
  WindowChanged: function() {
    ...
    var bodyW = document.documentElement.clientWidth,
        ...
        newUnitW = ((bodyW - 56) - (bodyW % 80)) / 16,
        newUnitH = ((bodyH - 56) - (bodyH % 100)) / 20,
    ...
    if (bodyW < 480){
      ...
      newUnitW = ((bodyW - 44) - (bodyW % 80)) / 16;
      newUnitH = ((bodyH - 44) - (bodyH % 100)) / 20;
      newUnitMin = Math.max(Math.min(newUnitW, newUnitH), 20);   
    }
    ...
    if (bodyW < 480) {
      ...
      var topPos = ((bodyH - bottomLimit) + 44) / 2,
        leftPos = (bodyW / 2) - (this.Game.W / 2),
        rightOffset = bodyW - (leftPos + rightLimit) - this.unitSize * 0.5;       
      ...
      var topPos = ((bodyH - bottomLimit) + 56) / 2,
        leftPos = (bodyW / 2) - (this.Game.W / 2),
        rightOffset = bodyW - (leftPos + rightLimit) - this.unitSize * 0.5;       
